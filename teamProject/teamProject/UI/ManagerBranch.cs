...
namespace teamProject.UI
{
    partial class ManagerBranch : UserControl
    {
        ...
        private void managerBranchList_ColumnClick(object sender, ColumnClickEventArgs e)
        {
            if (m_Columnclick == true)
                L_branchList.ListViewItemSorter = new ListViewItemComparerASC(e.Column);
            else
                L_branchList.ListViewItemSorter = new ListViewItemComparerDESC(e.Column);
