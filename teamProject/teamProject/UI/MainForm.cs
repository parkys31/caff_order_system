...
#pragma warning restore CS0108
        ...
        const string UC_USERMAIN = "UserMain";
        const string UC_ROOTMAIN = "RootMain";
        ...
        {
            controllView(new UserMain(), UC_USERMAIN);
        }

        private void rootMainView()
        {
            controllView(new RootMain(), UC_ROOTMAIN);
        }
        ...
        {
            iniCreate.SetValue(iniPath, "public", "authority", "");
            iniCreate.SetValue(iniPath, "public", "branchCode", "");
