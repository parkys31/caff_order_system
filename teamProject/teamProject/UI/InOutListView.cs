...
namespace teamProject.UI
{
    partial class InOutListView : UserControl
    {
        ...
        private void inOutList_ColumnClick(object sender, ColumnClickEventArgs e)
        {
            if (m_Columnclick == true)
                warehousingList.ListViewItemSorter = new ListViewItemComparerASC(e.Column);
            else
                warehousingList.ListViewItemSorter = new ListViewItemComparerDESC(e.Column);
